...
|---|---|---|---|---|---|
| `data/interim/repository_activity_summary.parquet` | BigQuery discovery (Milestone B) | GH Archive monthly tables, `config/repo_filters.yaml`, `config/bot_patterns.yaml` | `codetalent bq discover --domain cloud_devops --start 2026-05-01 --end 2026-07-31` | — | **not yet run** |
| `data/interim/cloud_devops_repository_candidates.parquet` | BigQuery discovery (Milestone B) | `repository_activity_summary.parquet`, activity filters | `codetalent bq discover --domain cloud_devops --start 2026-05-01 --end 2026-07-31` | — | **not yet run** |
...
| Contributor activity | GH Archive contributor-domain extraction (Milestone D) | Qualified repositories, GH Archive events | `codetalent bq discover` contributor stage / `sql/05_extract_contributor_activity.sql` | — | **not yet run** |
